...
@section('content')
    ...
    <section class="content-grid" id="analytics">
        <div class="glass-card chart-card">
            <div class="card-header">
                ...
                <div class="card-actions">
                    <button class="card-btn active" type="button">Monthly</button>
                    <button class="card-btn" type="button">Weekly</button>
                    <button class="card-btn" type="button">Daily</button>
                </div>
            </div>
        ...
        <div class="glass-card table-card" id="recent-transactions">
            <div class="card-header">
                <div>
                ...
                <div class="card-actions">
                    <button class="card-btn" type="button">View All</button>
                    <button class="card-btn" type="button">Export</button>
                </div>
            </div>
    ...
    <section class="bottom-grid">
        <div class="glass-card">
            <div class="calendar-header">
                ...
                <div class="calendar-nav">
                    <button class="calendar-nav-btn" type="button">
        ...
        <div class="glass-card progress-card" id="project-progress">
            <div class="card-header">
                <div>
